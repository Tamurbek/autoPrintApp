...
abstract class AppLocalizations {
  ...
  /// No description provided for @windowsPosPrinting.
  ///
  /// In en, this message translates to:
  /// **'Windows POS Printing Service'**
  String get windowsPosPrinting;
  ...
  /// No description provided for @automaticPrinting.
  ///
  /// In en, this message translates to:
  /// **'Automatic Printing'**
  String get automaticPrinting;
  ...
  /// No description provided for @startAtBoot.
  ///
  /// In en, this message translates to:
  /// **'Start on Windows Boot'**
  String get startAtBoot;
